function runIceFrontTestSF()
  ...
  for i = indexs
    ...
    for k = tcline_heights
        ...
        experiment_parameters.yicefront = y;
        path_part1 = convertStringsToChars(strcat("experiments/icefrontsf-GLIB-explore-",int2str(rng_seed),"/"));
        path_part2 = convertStringsToChars(strcat("at",int2str(k),"y",int2str(y)));
